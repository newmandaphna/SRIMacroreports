"""therapists, sessions, data sources, sync runs, import errors

Revision ID: 0d32800a2e28
Revises: 2383d1ad9f8f
Create Date: 2026-07-27 15:40:01.377871+00:00
"""
...
revision: str = "0d32800a2e28"
down_revision: str | None = "2383d1ad9f8f"
...
def upgrade() -> None:
    ...
    with op.batch_alter_table("therapist_aliases", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_therapist_aliases_therapist_id"), ["therapist_id"], unique=False
        )
    ...
    with op.batch_alter_table("lookups", schema=None) as batch_op:
        batch_op.create_index(batch_op.f("ix_lookups_kind"), ["kind"], unique=False)
        batch_op.create_index(batch_op.f("ix_lookups_short_code"), ["short_code"], unique=False)
    ...
    with op.batch_alter_table("import_errors", schema=None) as batch_op:
        batch_op.create_index(batch_op.f("ix_import_errors_reason"), ["reason"], unique=False)
        batch_op.create_index(batch_op.f("ix_import_errors_source_id"), ["source_id"], unique=False)
        batch_op.create_index(
            batch_op.f("ix_import_errors_sync_run_id"), ["sync_run_id"], unique=False
        )
    ...
    with op.batch_alter_table("sessions", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_sessions_insurance_short"), ["insurance_short"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_sessions_location_short"), ["location_short"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_sessions_patient_code"), ["patient_code"], unique=False
        )
        batch_op.create_index(batch_op.f("ix_sessions_source_id"), ["source_id"], unique=False)
        batch_op.create_index(
            batch_op.f("ix_sessions_therapist_id"), ["therapist_id"], unique=False
        )
        batch_op.create_index("ix_visit_cpt_base", ["cpt_base"], unique=False)
        batch_op.create_index("ix_visit_dos", ["dos"], unique=False)
        batch_op.create_index("ix_visit_therapist_dos", ["therapist_id", "dos"], unique=False)
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table("sessions", schema=None) as batch_op:
        batch_op.drop_index("ix_visit_therapist_dos")
        batch_op.drop_index("ix_visit_dos")
        batch_op.drop_index("ix_visit_cpt_base")
        batch_op.drop_index(batch_op.f("ix_sessions_therapist_id"))
        batch_op.drop_index(batch_op.f("ix_sessions_source_id"))
        batch_op.drop_index(batch_op.f("ix_sessions_patient_code"))
        batch_op.drop_index(batch_op.f("ix_sessions_location_short"))
        batch_op.drop_index(batch_op.f("ix_sessions_insurance_short"))

    op.drop_table("sessions")
    with op.batch_alter_table("import_errors", schema=None) as batch_op:
        batch_op.drop_index(batch_op.f("ix_import_errors_sync_run_id"))
        batch_op.drop_index(batch_op.f("ix_import_errors_source_id"))
        batch_op.drop_index(batch_op.f("ix_import_errors_reason"))

    op.drop_table("import_errors")
    with op.batch_alter_table("sync_runs", schema=None) as batch_op:
        batch_op.drop_index(batch_op.f("ix_sync_runs_source_id"))

    op.drop_table("sync_runs")
    with op.batch_alter_table("lookups", schema=None) as batch_op:
        batch_op.drop_index(batch_op.f("ix_lookups_short_code"))
        batch_op.drop_index(batch_op.f("ix_lookups_kind"))

    op.drop_table("lookups")
    with op.batch_alter_table("therapist_aliases", schema=None) as batch_op:
        batch_op.drop_index(batch_op.f("ix_therapist_aliases_therapist_id"))
